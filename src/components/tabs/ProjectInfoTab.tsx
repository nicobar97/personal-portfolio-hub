        ...
        <MobileFrame>
          <AnimatedBox themestyle={themeStyle.style}>
            ...
            <Paragraph>
              ...
              TypeScript hosted on Vercel, and a backend built with Node.js and TypeScript hosted on
              Heroku. The frontend and backend communicate with each other through a REST API.
            </Paragraph>
            <SubTitle>Backend</SubTitle>
            <Paragraph>
              The backend component serves as the server-side code for the portfolio application. It
              handles data storage, retrieval, and business logic. Here are some of the main modules
              utilized in the backend:
            </Paragraph>
            <BulletList>
              <BulletRow>
              ...
              <BulletRow>
                <strong>Awilix:</strong> A dependency injection container for Node.js applications.
              </BulletRow>
              <BulletRow>
            ...
            <Paragraph>
              The frontend is built with React, TypeScript, and Vite, providing a smooth development
              experience. Some key modules used in the frontend are:
            </Paragraph>
            <BulletList>
              <BulletRow>
              ...
              <BulletRow>
                <strong>React-Router-Dom:</strong> A routing library for handling navigation in the
                React app.
              </BulletRow>
            </BulletList>
            <Paragraph>To run the frontend, clone the repository and install the dependencies with:</Paragraph>
            <pre>
              <code>yarn install</code>
            </pre>
            <Paragraph>After successful installation, start the development server with:</Paragraph>
            <pre>
              <code>yarn dev</code>
            </pre>
            ...
            <ol>
              ...
              <BulletRow>
                <strong>Article Page:</strong> Displays articles that have been generated by the AI.
              </BulletRow>
            </ol>
            ...
            <ol>
              ...
              <BulletRow>
                Install the required dependencies for each component using <code>yarn install</code>
                .
              </BulletRow>
              <BulletRow>
            ...
            <Paragraph>Enjoy exploring the project and its AI-powered content generation capabilities!</Paragraph>
            <Paragraph>
