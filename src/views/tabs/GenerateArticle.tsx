...
export const GenerateArticle: React.FC = () => {
  ...
  const label = mutation.isIdle
    ...
    : mutation.isSuccess
    ? mutation.data
        .map(() => 'Article Generation Success!')
            ...
            <AnimatedBox themestyle={themeStyle.style}>
              <Gap>
                ...
                <Disclamer>
                  ...
                  accurate and should not be solely relied upon for critical decisions. AI
                  generation feature is limited to one generation per day to maintain content
                  quality and integrity. For crucial matters, always consult reliable human sources.
                </Disclamer>
                <BubbleContainer>
                  <BubbleButton
